<template>
    <div>
        <v-flex pa-3>
            ...
            <v-toolbar-title>Class rooms Details</v-toolbar-title>
            <v-divider
                class="mx-2"
                inset
                vertical
            ...
            <span> Total No of Class rooms : <b> {{ allClassRooms.length }} </b> </span>
            <v-spacer></v-spacer>
...
import form from './AddClassRoom.vue'
    ...
    export default {
        ...
        methods: {
            ...
            // set class_room details to dialog form when edit
                updateclass_room : 'class_room/set_edit_class_room',
